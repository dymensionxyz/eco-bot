...
func addTradersToGroup(operatorName, operatorAddress string, groupID int, client cosmosclient.Client, newAccs []account) error {
...
func addFeeGrantToTrader(client cosmosClient, fromName string, granterAddr sdk.AccAddress, granteeAddr ...sdk.AccAddress) error {
